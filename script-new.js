...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Project filtering functionality with flip cards
    // Notice we're redefining filterButtons here, but that's handled in flip-cards.js now
    // This is kept only for compatibility with older code
    /* const filterButtons = document.querySelectorAll('.filter-btn');
    const projectCards = document.querySelectorAll('.flip-card-container'); */
      // This functionality is now handled by flip-cards.js
